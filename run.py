...
cities = [
    ...
    "Delhi", "MexicoCity", "Cairo", "Berlin", "Mumbai", "Beijing",
    "Dhaka", "Osaka", "New York", "Karachi", "BuenosAries", "Istanbul",
    "Manila", "RiodeJaneiro", "LosAngeles", "Lima", "Bangok", "Seoul",
    "Teheran", "Chicago", "Chengdu", "Nanjing", "Wuhan", "Luanda",
    "Santiago", "Baghdad", "Damascus", "Pune", "Madrid", "Barcelona",
    "Harbin", "Surad", "Dallas", "Gothenburg", "Miami", "Toronto", "Hamburg",
    "Atlanta", "Fukuoka", "Singapore", "BeloHorizonte", "Khartoum", "Dalian",
    "SaintPetersburg", "Alexandria", "Jinan", "Guadalajara", "Shangai",
    "SaoPaulo", "Tianjin", "Lagos", "Kinshasa"
]
countries = [
    "Hungary", "Austria", "Italy", "Brazil", "Japan", "Ireland",
    "Sweden", "Cuba", "NewZeland", "Venezuela", "Colombia", "Chile",
    "Peru", "Marocco", "Kenya", "Nigeria", "Bangladesh", "Philipines",
    "Portugal", "Ukraine", "Russia", "Pakistan", "Vietna", "China",
    "Iran", "Norway", "Finland", "Switzerland", "Netherlands", "SouthKorea",
    "Belgium", "Denmark", "Germany", "Spain", "Croatia", "Bulgaria", "Romania",
    "Mexico", "Argentina", "SouthAfrica", "Poland", "Egypt", "Indonesia",
    "Greece", "Turkey", "Estonia"
]
flowers = [
    "wisteria", "verbena", "sweetpea", "tigerlily", "peony",
    "narcissus", "rose", "tulip", "daisy", "lily", "peonies",
    "hydrangea", "poppy", "marigold", "daffodil", "orchid",
    "aster", "lilac", "zinnia", "dahlia", "azalea", "anemone",
    "cosmos", "fuchsia", "pansy", "zinnia", "dahlia", "lavander",
    "iris", "anemone", "crocus", "hibiscus", "camellia",
    "ranuncuus", "gerbera", "forgetmenot", "azalea"
]
languages = [
    "Punjabi", "Gujarti", "Somali", "Zulu", "English",
    "Spanish", "Arabic", "Albanian", "Slovenian", "French",
    "German", "Italian", "Portuguese", "Estonian", "Latvian",
    "Lithuanian", "Tagalog", "Malay", "Ukrainian", "Bulgarian",
    "Slovak", "Hungarian", "Czech", "Romanian", "Danish", "Norwegian",
    "Finnish", "Turkish", "Thai", "Vietnamese", "Polish", "Greek",
    "Swedish", "Dutch", "Korean", "Indonesian", "Russian", "Japanese",
    "Chinese", "Hindi", "Bengali", "Urdu"
]
fruits = [
    "gooseberry", "soursop", "kumquat", "ackee", "elderberry",
    "rhubarb", "honeydew", "startfruit", "mandarin", "apple",
    "pear", "strawberry", "banana", "orange", "grape",
    "peach", "watermelon", "blueberry", "mango", "kiwi", "pineapple",
    "cherry", "guava", "pomegranate", "cranberry", "blackberry",
    "kiwifruit", "papaya", "lychee", "coconout", "nectarine", "mulberry",
    "clementine"
]
